//
//  soilRecomendedCollectionViewCell.swift
//  App_Plantex_Sypher
//
...
class soilRecomendedCollectionViewCell: UICollectionViewCell {
    
    
    static let identifier = "SoilCell"
    ...
    func configure(with soil: SoilScane) {
        plantImage.image = UIImage(named: soil.image)
        plantNameLabel.text = soil.name
    }
}
